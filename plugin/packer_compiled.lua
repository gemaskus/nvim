...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/home/grant/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/theprimeagen/harpoon"
  },
  kanagawa = {
    config = { "\27LJ\2\0028\0\0\2\0\3\0\0056\0\0\0009\0\1\0'\1\2\0B\0\2\1K\0\1\0\25colorscheme kanagawa\bcmd\bvim\0" },
    loaded = true,
    path = "/home/grant/.local/share/nvim/site/pack/packer/start/kanagawa",
  ...
  playground = {
    loaded = true,
    path = "/home/grant/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["vim-closer"] = {
    loaded = true,
    path = "/home/grant/.local/share/nvim/site/pack/packer/start/vim-closer",
